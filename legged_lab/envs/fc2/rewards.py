...
if TYPE_CHECKING:
    from legged_lab.envs.fc2.fc2_env import fc2Env as BaseEnv
...
def base_height_reward(
    ...
    if feet_cfg is None:
        # 默认为机器人定义的 feet_cfg
        feet_cfg = getattr(env, "feet_cfg", SceneEntityCfg("robot", body_names=".*foot.*"))

    # feet z 坐标
    feet_z = asset.data.body_pos_w[:, feet_cfg.body_ids, 2]  # [N, num_feet]
