...
class fc2Env(VecEnv):
    ...
    def compute_ref_state(self):
        ...
        self.ref_dof_pos[:, jn["lhipPitch"]] = sin_pos_l * scale_1
        self.ref_dof_pos[:, jn["lknee"]] = -sin_pos_l * scale_2
        self.ref_dof_pos[:, jn["lankle1"]] = sin_pos_l * scale_3

        # 右腿 swing phase
        sin_pos_r[sin_pos_r < 0] = 0
        self.ref_dof_pos[:, jn["rhipPitch"]] = -sin_pos_r * scale_1
        self.ref_dof_pos[:, jn["rknee"]] = sin_pos_r * scale_2
        self.ref_dof_pos[:, jn["rankle1"]] = -sin_pos_r * scale_3
