...
from legged_lab.envs.tiangong.tiangong_env import tiangongEnv

from legged_lab.envs.tiangong.tiangong_config_diy import(
    tiangongFlatEnvCfg,
    tiangongFlatAgentCfg,
    tiangongRoughAgentCfg,
    tiangongRoughEnvCfg,
)
...
task_registry.register("bhr8_flat", tiangongEnv, tiangongFlatEnvCfg(), tiangongFlatAgentCfg())
task_registry.register("bhr8_rough", tiangongEnv, tiangongRoughEnvCfg(), tiangongRoughAgentCfg())